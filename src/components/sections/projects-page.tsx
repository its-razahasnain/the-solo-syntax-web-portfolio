  ...
  return (
    <div className="flex h-8 items-center gap-1.5 border-b border-white/[0.07] bg-[#090a0d] px-3">
      ...
      <div className="ml-3 flex h-4 flex-1 items-center rounded-full border border-white/[0.05] bg-white/[0.025] px-3">
        <span className="truncate font-mono text-[6px] text-zinc-700">
          {label}
        </span>
      </div>
...
function ComingSoonOverlay() {
  return (
    <>
      <div className="pointer-events-none absolute inset-0 z-20 bg-black/[0.08]" />

      <div className="pointer-events-none absolute inset-0 z-30 flex items-center justify-center">
        <div className="rounded-full border border-white/[0.12] bg-black/50 px-3.5 py-2 text-[8px] font-medium uppercase tracking-[0.2em] text-zinc-300 shadow-2xl backdrop-blur-md sm:px-4 sm:py-2.5 sm:text-[9px]">
          Coming Soon
        </div>
      </div>
    </>
  ...
  return (
    <span
      className={`rounded-full border px-2.5 py-1 text-[9px] font-medium uppercase tracking-[0.14em] ${
        isBuilt
          ? "border-blue-400/[0.14] bg-blue-500/[0.05] text-blue-300/70"
          : "border-white/[0.08] bg-white/[0.025] text-zinc-500"
      }`}
    >
      {isBuilt ? "Built" : "Concept · Coming Soon"}
    </span>
  );
}
          ...
          <div className="grid gap-14 lg:grid-cols-[1fr_0.62fr] lg:items-end lg:gap-20">
            <div>
              ...
              <p className="mt-8 max-w-2xl text-base leading-8 text-zinc-400 sm:text-lg">
                A selection of digital experiences, including a fully built
                portfolio project and concepts in development for future
                releases.
              </p>
                ...
                <div className="p-6 sm:p-7">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-zinc-500">Built</span>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-zinc-500">Concepts</span>
          ...
          <div className="mb-12 sm:mb-14">
            <div className="flex items-end justify-between gap-6">
              <div className="min-w-0">
                ...
                <h2 className="text-4xl font-semibold leading-[0.95] tracking-[-0.055em] text-white sm:text-5xl">
                  Selected{" "}
                  <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-500 bg-clip-text text-transparent">
                    projects.
                  </span>
                ...
                <p className="mt-4 max-w-xl text-sm leading-6 text-zinc-500 sm:text-[15px] sm:leading-7">
                  A mix of built work and concepts exploring modern, useful web
                  experiences.
                </p>
              </div>
                ...
                >
                  ...
                  >
                      ...
                      <BrowserBar
                        label={
                          isBuilt
                            ...
                            : `${project.name.toLowerCase()} · concept`
                        }
                      />
                    ...
                    <div className="absolute bottom-5 right-5 flex items-center gap-2">
                      <span className="rounded-full border border-white/[0.08] bg-black/30 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.14em] text-zinc-500 backdrop-blur-md">
                        {project.category}
                      </span>
                  ...
                  <div className="flex items-start justify-between gap-6 p-6 sm:p-7">
                    <div className="min-w-0">
                      ...
                      <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-medium text-zinc-400">
                        {isBuilt
